package dsapractise.educative.slowfastpointer;
...
public class SlowFastPointers {
    ...
    static void printList(ListNode head, String str) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Is palindrome: " + SlowFastPointers.isPalindrome(head));
