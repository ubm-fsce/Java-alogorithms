...
// in BST.
    ...
    /*
   TODO: 52) Give an algorithm for finding the shortest path between two nodes in a BST
     */
...
// than b before making a call to findDistWrapper()
    ...
    /*
         TODO: 54) Given pointers to two nodes in a binary search tree, find the lowest common
    ...
    private Node lca(Node node, int n1, int n2) {
        ...
        if (node.key > n1 && node.key > n2) return lca(node.left, n1, n2);
        // If both n1 and n2 are greater than root, then LCA lies in right
        if (node.key < n1 && node.key < n2) return lca(node.right, n1, n2);
        return node;
    }

    /*
        TODO: 55) Approach 1 :  Give an algorithm to check whether the given binary tree is a BST or not.
        */
    ...
    /*
           TODO: 55) Approach 2 : Give an algorithm to check whether the given binary tree is a BST or not.
           */
    ...
    private boolean isBSTApproach2(Node root, Node l, Node r) {
        ...
        if (l != null && root.key <= l.key) return false;
        // if right node exist then check it has
        // correct data or not i.e. right node's data
        // should be greater than root's data
        if (r != null && root.key >= r.key) return false;
    ...
    // TODO :59)  Give an algorithm for converting BST to circular DLL with space complexity
   ...
   /*     sdbn.insert(root, 10);
       ...
       // System.out.println(sdbn.findDistWrapper(root, 5, 35));
        ...
        //TODO: 55) Give an algorithm to check whether the given binary tree is a BST or not.
        //System.out.println(sdbn.isBSTUtil(root, Integer.MIN_VALUE, Integer.MAX_VALUE));
        //TODO: 55) Approach 2 : 55) Approach 2 : Give an algorithm to check whether the given binary tree is a BST or not.
