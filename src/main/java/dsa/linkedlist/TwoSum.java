...
public class TwoSum {
    ...
    public static void main(String[] args) {
        ListNode lc3 = new ListNode(3);
        ListNode lc2 = new ListNode(4, lc3);
        ListNode lc = new ListNode(2, lc2);

        ListNode nc3 = new ListNode(4);
        ListNode nc2 = new ListNode(6, nc3);
        ListNode nc = new ListNode(5, nc2);
        TwoSum twoSum = new TwoSum();

        twoSum.addTwoNumbers(lc, nc);
